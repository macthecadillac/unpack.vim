...
function! unpack#code#gen(state, configuration)
  ...
  call add(l:output.unpack, '" autogenerated by unpack#compile()')
  call add(l:output.unpack, '" place-holder to bypass calling unpack')
  call add(l:output.unpack, 'function! unpack#begin()')
  call add(l:output.unpack, 'endfunction')
  call add(l:output.unpack, 'function! unpack#end()')
  call add(l:output.unpack, 'endfunction')
  call add(l:output.unpack, 'command! -nargs=+ Unpack echo ""')
  return l:output
endfunction

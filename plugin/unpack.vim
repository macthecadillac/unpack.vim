...
command! -nargs=* -complete=custom,unpack#list UnpackInstall call unpack#install(<args>)
command! -nargs=* -complete=custom,unpack#list UnpackUpdate call unpack#update(<args>)
